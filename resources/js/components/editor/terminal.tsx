...
export default function Terminal({ output, isWaitingForInput, userInputs, onInput, onClear }: TerminalProps) {
    ...
    return (
        <div className="flex h-84 flex-col rounded-lg border border-gray-700 bg-gray-900">
            ...
            <div className="flex items-center justify-between border-b border-gray-700 bg-gray-800 px-4 py-2">
                ...
                <button onClick={handleClear} className="rounded px-2 py-1 text-sm text-gray-400 hover:bg-gray-700 hover:text-white">
                    Clear
                </button>
            </div>
