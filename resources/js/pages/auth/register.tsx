              ...
              {({ processing, errors }) => (
                <>
                  <div className="grid gap-6">
                    ...
                    <Button
                      type="submit"
                      className="mt-2 w-full bg-[var(--color-button-primary-bg)] hover:bg-[var(--color-button-primary-hover)] text-white rounded-lg py-3 font-semibold transition transform hover:scale-[1.02] shadow-lg"
                      tabIndex={5}
                      disabled={processing}
                    >
                      {processing && (
                  ...
                  <div className="text-center text-sm text-[var(--color-text-secondary)] mt-6">
