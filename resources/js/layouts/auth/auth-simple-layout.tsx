          ...
          <div className="mb-6 flex flex-col items-center gap-4">
            <Link href={home()} className="group flex flex-col items-center gap-2 font-medium">
              <div className="relative mb-2 flex items-center justify-center">
                ...
                <div className="flex h-12 w-12 transform items-center justify-center rounded-lg bg-transparent transition-transform duration-300 group-hover:scale-105">
                  <img
                ...
                <span className="absolute text-[9px] leading-none font-bold tracking-wider text-black uppercase dark:text-white">
                  MM
                </span>
              </div>
            </Link>
