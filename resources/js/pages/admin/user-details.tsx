...
import { Activity, ArrowLeft, Calendar, Clock, Edit, Mail, Settings, Shield, Trash2, User, UserCheck, UserX } from 'lucide-react';
                                ...
                                {user.email_verified_at && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">{formatDate(user.email_verified_at)}</p>
                                        </div>
                                    </div>
                                )}
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                ...
                                <Button variant="outline" className="w-full justify-start text-red-600 hover:text-red-700" onClick={handleDeleteUser}>
